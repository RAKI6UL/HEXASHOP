...
class Comment(models.Model):
    ...
    product = models.ForeignKey(
        Product, 
        on_delete=models.CASCADE  # Delete comment if product is deleted
    )
    ...
    def __str__(self):
        return f"Comment by {self.user.username if self.user else 'Unknown User'} for {self.product.product_name}"
